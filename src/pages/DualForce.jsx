...
export default function DualForce() {
  ...
  const metricas = useMemo(() => {
    ...
    const totalAtividades = dadosAPI.reduce((acc, i) => acc + sanitizarValor(i.qtde_atividades_mes), 0);
  ...
  async function carregarDados() {
    ...
    try {
      ...
      const [resResumo, resHist, resTipos, resEvolucao] = await Promise.all([
        api.get(`/resumo-geral?${params}`),
        api.get(`/historico-global?${params}`),
        api.get(`/distribuicao?${params}`),
        api.get(`/evolucao?${params}`),
      ]);
  ...
  const tiposOptions = useMemo(() => ({
    ...
    plotOptions: { 
        bar: { 
            ...
            distributed: true, 
            columnWidth: '60%',
            dataLabels: { position: 'top' } // VALORES NO TOPO DA BARRA
        } 
    },
    dataLabels: {
        enabled: true,
  ...
  <span className="page-title"></span>
        ...
        <div className="header-right">
            <div className="action-buttons">
                ...
                <button className="btn-icon" onClick={toggleFullscreen} title="Tela Cheia">
                ...
                <div className="main-column">
                    ...
                    <div className="kpis-row kpis-main">
                        <div className="kpi-card">
                            ...
                            <div className="kpi-content">
                                ...
                                <div className="kpi-meta">{metricas.perc30dNoTotal}% dos últimos 30 dias</div>
                            </div>
                        </div>
                        <div className="kpi-card">
                        ...
                        <div className="kpi-card">
                            ...
                            <div className="kpi-content">
                                ...
                                <div className="kpi-meta" style={{fontSize:'9px'}}>
                                    {metricas.perc30dNos60d}% (30d) | {metricas.percRestante60d}% (Anterior)
                                </div>
                            </div>
                        </div>
                        <div className="kpi-card">
                            ...
                            <div className="kpi-content">
                                ...
                                <div className="kpi-value">{metricas.totalClientesRisco}</div>
                                <div className="kpi-meta">Clientes não visitados no período</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="kpis-row kpis-secundarios">
                        <div className="kpi-card">
                            ...
                            <div className="kpi-content">
                                ...
                                <div className="kpi-value">{metricas.totalClientesVisitados}</div>
                                <div className="kpi-meta">Clientes com agenda realizada</div>
                            </div>
                        </div>
                        <div className="kpi-card">
                        ...
                        <div className="kpi-card">
                            ...
                            <div className="kpi-content">
                                ...
                                <div className="kpi-value">{(metricas.totalAtividades/22).toFixed(1)}</div>
                                <div className="kpi-meta">Média de atividades por dia</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="cards-row-horizontal">
                        <div className="card card-carteira">
                            <div className="card-label" style={{display:'flex', justifyContent:'space-between'}}>
                                <span>Cobertura</span>
                                <span>{metricas.totalClientesVisitados}/{metricas.totalClientes} ({metricas.percVisitado}%)</span>
                            </div>
                        ...
                        <div className="card meta-card-horizontal">
                            <div className="card-label" style={{display:'flex', justifyContent:'space-between'}}>
                                ...
                                <span>{metricas.totalAtividades}/{metricas.totalMeta} ({metricas.percMetaGlobal}%)</span>
                            </div>
                            <div className="progress-bar-section">
                                <div className="progress-bar">
                                    <div className="progress-fill" style={{width: `${Math.min(metricas.percMetaGlobal,100)}%`}}/>
                                </div>
                            </div>
                            <div style={{fontSize:'10px', color:'#64748b', marginTop:'4px', display:'flex', justifyContent:'space-between'}}>
                    ...
                    <div className="graphs-row">
                        <div className="card grafico-historico-card">
                            <div className="grafico-header"><span className="card-label">Evolução</span></div>
                            {historico.length > 0 ? (
                                <div style={{width: '100%', height: '100%', minHeight: '150px'}}>
                                    <ReactApexChart options={histOptions} series={histSeries} type="line" height="100%" width="100%"/>
                                </div>
                            ) : (
                                ...
                                <tbody>
                                    {dadosAPI.length > 0 ? dadosAPI.map((i, idx) => (
                                        <tr key={idx}>
                                            ...
                                            <td>{i.pct_meta_atividades_mes?.toFixed(1)}%</td>
